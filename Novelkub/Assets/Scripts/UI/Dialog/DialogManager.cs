    ...
    private void GenerateQuestDialogData()
    {
        ...
        _dialogData.Add((int)ObjectNum.NPC1 + (int)QuestNum.First,
                        new string[] { "오! 탐정님 오랜만에 뵙는군요! 이쪽으로 오시죠.:1",              
									   ...
									   "일단 피해자는 사업가고 40대 남성입니다. 사망원인은 질식사로 보여집니다.:1",
									   "범행도구는 발견됐나요?:0",
        ...
        _dialogData.Add((int)ObjectNum.NPC2 + (int)QuestNum.Second,
                        new string[] { "실례합니다. 혹시 사장님 계십니까?:0",
									   ...
									   "탐정 양반이 여긴 무슨일로 왔수?:1",
									   "혹시 어제 22시에서 23시 사이에 호텔 근처에서 수상한 사람이나 수상한 물건같은거 보신적 있으십니까?.:0",
		...
		_dialogData.Add((int)ObjectNum.NPC3 + (int)QuestNum.Third + 1,
						new string[] { "어르신, 실례지만 위에 CCTV 어디서 확인할 수 있는지 아시나요?:0",
									   ...
									   "이 곳에서 수상한 사람을 봤다는 사람이 있어서 CCTV로 확인해보려합니다.:0",
									   "젊은 양반이 예의는 좀 아는구먼, 큼큼:1",
									   "그러면 저쪽에 있는 쓰레기들 좀 깔끔하게 정리해줘봐 내가 나이가 먹어서 그런지 허리가 아파서 영~ 힘들구만:1" });
		//미니게임 구현
		_dialogData.Add((int)ObjectNum.NPC3 + (int)QuestNum.Third +2,
						new string[] { "이제 좀 깔끔해졌구만, 자네가 쓰레기를 정리하는동안 내가 핸드폰으로 CCTV좀 찾아봤네.:1",
									   ...
									   "자 얼른 보고 범인좀 잡아주게 아침부터 동네가 시끄러워서 무릎이 쑤셔오는구먼..:1",
		...
		_dialogData.Add((int)ObjectNum.NPC4 + (int)QuestNum.Forth +1,
						new string[] { "후.. 오늘 왜이렇게 손님이 많은지.. 아저씨 없었으면 죽을뻔했네요..:1",
									   "아, 아저씨 뭐 때문에 오셨다고 했었죠?:1",
									   "후.. 아저씨는 아니고, 어제 일어난 살인사건을 조사하고있는 사설탐정입니다.:0",
									   "혹시 어제 오후 22시 30분 경에 들어온 손님 기억하나요?:0",
									   "어제요..? 아 기억나네요 23시에 마감해야하는데 22시 반에 들어와서 주문했던 아저씨 있었는데..:1",
									   "하.. 그 아저씨 괜히 와서 오븐스파게티 하나 꼴랑 시켜가지고 결국 어제 23시 반에 퇴근했다구요!:1",
									   "혹시 누군지 아시나요?:0",
									   "알죠! 출근할때마다 보는데, 요 앞에 지하철역 출구에서 맨날 쭈그려 앉아있는 노숙자 아저씨에요.:1",
									   "아마 지금은 지하철역 출구에 있거나 아니면 근처 공원에 있을거에요.:1",
									   "(당신의 수사가 마음에 안드는 경찰들은 수사를 훼방놓기 위해 당신을 찾으러 다니고 있다):0", 
									   "(돌아다니는 경찰들의 눈을 피해 지하쳘역 출구 주변과, 공원에서 노숙자를 찾은뒤 대화를 진행하자.):0"});
		...
		_dialogData.Add((int)ObjectNum.NPC5 + (int)QuestNum.Fifth,
						new string[] { "혹시 어젯밤에 저쪽 피자가게에 간적이 있으신가요?:0",
									   ...
									   "혹시 어제 오후 22시 30분 경에 들어온 손님 기억하나요?:0",
									   "오븐 스파게티! 맛.. 맛있었지 그럼 그럼 스파게티는 거..거기가 최고야 최고:1",
									   "혹시 어제 호텔도 들리셨죠? 호텔에서 뭘 하고 나오셨나요?:0",
									   "ㄴ..내가 수..숨겨놓은 내꺼! ㅇ..어제 숨겨놨는데 까..까먹었어 분명 이 주변 어디에 놔뒀었는데!!:1",
		...
		_dialogData.Add((int)ObjectNum.NPC5 + (int)QuestNum.Fifth +1,
						new string[] { "헤..헤헤 ㅈ..잘 찾아왔네! 이거야 이거!:1",
									   ...
									   "호..호텔.. 어제 호텔에서 이..이거 사온거야.. 마..마약상이랑 거..거기서 거래 했거든 ..거..거래 헤헤:1",
									   "그럼 혹시...:0",
									   "아..아니야!! 어젠 이..이거 하지도 않..않았다고! 그..급하게 숨겨놓느라 하지도 모..못했는데..:1",
									   "아 마..마약상 저..저기 펍..그래 펍! 거..거기서 바..바텐더로 일하던..그..그래 그남자야!:1", 
									   "나한테 그..그거 판거 그 바..바텐더라고!!:1",
									   "(아무래도 더이상 노숙자와의 대화는 힘들것 같다. 노숙자의 말에 신뢰가 가진 않지만 우선 마약을 판매한 건 바텐더일수도 있을 것 같다):0",
									   "(곧 저녁이니 펍이 열었을 수도 있다. 펍에 가서 바텐더와 대화해보자):0"});

		_dialogData.Add((int)ObjectNum.NPC6 + (int)QuestNum.Sixth,
						new string[] { "실례합니다.:0",
									   "어서오세요. 어떤걸로 드릴까요?:1",
									   "아. 손님은 아니고 어젯밤에 일어난 살인사건을 조사하고있는 사설탐정입니다. 잠깐 시간 괜찮으십니까?:0",
									   "저희 지금 영업중이라 개인적으로 시간을 내기는 힘듭니다. 영업이 끝나고 와주시겠어요?:1",
									   "어제 오후 22시30분 경 호텔 안에서 노숙자 한명에게 마약 판매 하셨죠?:0",
									   "제가요? 허 어디서 정신나간 노숙자한테 무슨 소리를 듣고 오신지는 몰라도 제가요? 마약?:1", 
									   "전 그런 불법적인거랑은 거리가 먼 선량한 바텐더입니다! 무례하시군요:1",
									   "(바텐더의 입꼬리가 살짝 떨리는것 같았지만 이대로 증거 없이는 끝까지 발뺌할 것 같다..):0",
		...
		_dialogData.Add((int)ObjectNum.NPC6 + (int)QuestNum.Sixth +1,
						new string[] { "또 오셨군요. 이번엔 어떤거 때문에 그러시죠?:1",
									   ...
									   "부탁이요? 누구한테서 부탁받은거죠?:0",
									   "그..그건.. 하.. 어젯밤에 죽었다던 그 사업가의 부인한테 부탁받았습니다.. 젠장 이렇게 큰 사건하고 엮일 줄 알았다면 이딴 부탁 받지 말았어야했는데!!:1",
									   "후... 전 그 살인사건이랑 전혀 관련없어요 아마.. 그 여자일꺼에요 죽은 남자의 부인!! 나는 이용당한것 뿐이라고요!!!:1",
