...
public class DialogManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _MiniGame = new int[5, 3] { { 2200, 0, 5 }, { (int)ObjectNum.NPC3 + (int)QuestNum.Third , 0, 5 }, { (int)ObjectNum.NPC4 + (int)QuestNum.Forth, 0, 8 }, { (int)ObjectNum.NPC5 + (int)QuestNum.Fifth, 0, 7 }, { (int)ObjectNum.NPC5 + (int)QuestNum.Fifth + 1, 0, 10 } };
    }
